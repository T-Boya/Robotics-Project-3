...
%for i=1:101
 %   for j = 1:8
 %       [sdhdiff, mdhdiff] = elbow_POE_SDH_MDH(T(i, j));
 %   end
%end
...
for i = 1:8
    ...
    t1 = T{1, i};
    t2 = T{2, i};
    d = norm(t2(1:3, 4) - t1(1:3, 4));
    v = d/dt;
    velocities(i) = v;
end
[~, highestspeed] = max(velocities);

% find q3 variation
variation = zeros(1, 8);
for i = 1:8
    variation(i) = var(q(3,:,i));
end
